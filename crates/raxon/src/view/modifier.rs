...
pub trait ViewExt: View + Sized {
    ...
    fn on_pan(
        ...
        self.decorate(move |t, id| {
            t.on(id, EventKind::Pan, move |event| {
                if let crate::dom::Event::PanChanged {
                    translation,
                    velocity,
                    phase,
                    ..
    ...
    fn on_pinch(
        ...
        self.decorate(move |t, id| {
            t.on(id, EventKind::Pinch, move |event| {
                if let crate::dom::Event::PinchChanged {
                    scale,
                    velocity,
                    phase,
                    ..
    ...
    fn on_rotate(
        ...
        self.decorate(move |t, id| {
            t.on(id, EventKind::RotateChanged, move |event| {
                if let crate::dom::Event::RotateChanged {
                    rotation,
                    velocity,
                    phase,
                    ..
    ...
    ///
    /// Reads [`try_use_theme`](super::theme::try_use_theme) — if no theme is
